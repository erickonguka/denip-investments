...
@section('title', 'Create Project - Denip Investments Ltd')
@section('page-title', 'Create New Project')

@section('content')
<div class="dashboard-header">
    <h1>Create New Project</h1>
    <p>Start a new construction project with our team</p>
</div>
...
<div class="dashboard-section">
    <div class="wizard-container">
        ...
        <form id="createProjectForm" onsubmit="handleProjectSubmit(event)">
            @csrf
            ...
            <div class="wizard-step active" data-step="1">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group full-width">
                        ...
                        <x-rich-text-editor name="description" id="client-project-description-editor" height="200px" />
                    </div>
                </div>
            </div>
            ...
            <div class="wizard-actions">
                ...
                <a href="{{ route('client.projects.index') }}" class="btn btn-outline">Cancel</a>
            </div>
        </form>
    </div>
</div>
...
function validateStep(step) {
    ...
    if (step === 1) {
        if (window.client_project_description_editor) {
            const content = window.client_project_description_editor.root.innerHTML.trim();
...
async function handleProjectSubmit(event) {
    ...
    try {
        const response = await fetch('{{ route("client.projects.store") }}', {
            method: 'POST',
            headers: {
        ...
        setLoading(submitBtn, false, 'Create Project');
    }
}
